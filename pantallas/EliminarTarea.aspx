<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarTarea.aspx.cs" Inherits="Prodeo.pantallas.EliminarTarea" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="wrapper style3 container special">
				<div id="formInterno">
                        ...
                        <footer>
					            <ul class="buttons">
						            <li id="btnEliminarTarea" runat="server"><a class="button" onserverclick="eliminarTarea_Click" runat="server">Eliminar Tarea</a></li>
