...
{
    public partial class DesvincularProyecto : System.Web.UI.Page
    {
        public int proyecto;
        ...
        protected void desvincularProyecto_Click(object sender, EventArgs e)
        {
            ProyectoLogica proy = new ProyectoLogica();
            bool respuesta = proy.desvincularProyecto(Session["usuario"].ToString(),proyecto);
            if (respuesta)
            {
                Response.Redirect("~/pantallas/ListaProyectos.aspx");
            }
            ...
            {
                LabelElimTareas.Text = "No se pudo desvincular el proyecto " + datosPro.Nombre + "!";
            }
