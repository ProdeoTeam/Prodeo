<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarModulo.aspx.cs" Inherits="Prodeo.pantallas.EliminarModulo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="wrapper style3 container special">
				<div id="formInterno">
                        ...
                        <footer>
					            <ul class="buttons">
						            <li id="btnEliminarModulo" runat="server"><a class="button" onserverclick="eliminarModulo_Click" runat="server">Eliminar Modulo</a></li>
